...
" + Environment.StackTrace;
        ...
        internal static void SetAmbientScope(DbContextScope newAmbientScope)
        {
            ...
            var current = CallContext<InstanceIdentifier>.GetData(AmbientDbContextScopeKey) as InstanceIdentifier;
            ...
            CallContext<InstanceIdentifier>.SetData(AmbientDbContextScopeKey, newAmbientScope._instanceIdentifier);
        ...
        {
            var current = CallContext<InstanceIdentifier>.GetData(AmbientDbContextScopeKey);
            CallContext<InstanceIdentifier>.SetData(AmbientDbContextScopeKey, null);
        ...
        internal static DbContextScope GetAmbientScope()
        {
            ...
            var instanceIdentifier = CallContext<InstanceIdentifier>.GetData(AmbientDbContextScopeKey) as InstanceIdentifier;
